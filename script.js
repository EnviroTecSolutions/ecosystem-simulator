...
const rangerBadgePoints = 1000; // Points required for Ranger Badge
...
function draw() {
  ...
  // Ecosystem Dynamics
  grass += (rainfall / 10 - invasiveSpecies) - (50 - rainfall) / 10;
  pademelons += grass / 100 - devils / 10 - visitors - temperature / 5;
  devils += pademelons / 60 - temperature / 10 - visitors / 4;
